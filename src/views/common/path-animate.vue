<template>
  <div>
    <Tabs value="name1">
      <TabPane label="开始" name="name1">
        <img src="@/assets/svg-animate-along-path-600.gif" alt="">
      </TabPane>
      <TabPane label="路径动画1" name="name2">
        <svg width="52px" height="9px" viewBox="0 0 52 9" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="Apple-Watch-38mm-Copy-3" transform="translate(-372.000000, -414.000000)" :fill="fill" fill-rule="nonzero">
                    <g id="分组-22" transform="translate(207.000000, 220.000000)">
                        <g id="分组-28" transform="translate(166.000000, 36.866394)">
                            <path id="直线" d="M41.5,162.133606 L40,162.133606 L39.5,162.133606 L39.5,161.133606 L40,161.133606 L41.5,161.133606 L41.5,157.133606 L50.5,161.633606 L41.5,166.133606 L41.5,162.133606 Z M-3.55271368e-15,162.133606 L-0.5,162.133606 L-0.5,161.133606 L-3.55271368e-15,161.133606 L5,161.133606 L5.5,161.133606 L5.5,162.133606 L5,162.133606 L-3.55271368e-15,162.133606 Z M10,162.133606 L9.5,162.133606 L9.5,161.133606 L10,161.133606 L15,161.133606 L15.5,161.133606 L15.5,162.133606 L15,162.133606 L10,162.133606 Z M20,162.133606 L19.5,162.133606 L19.5,161.133606 L20,161.133606 L25,161.133606 L25.5,161.133606 L25.5,162.133606 L25,162.133606 L20,162.133606 Z M30,162.133606 L29.5,162.133606 L29.5,161.133606 L30,161.133606 L35,161.133606 L35.5,161.133606 L35.5,162.133606 L35,162.133606 L30,162.133606 Z"></path>
                            <path :id="id" d="M41.5,162.133606 L40,162.133606 L39.5,162.133606 L39.5,161.133606 L40,161.133606 L41.5,161.133606 L41.5,157.133606 L50.5,161.633606 L41.5,166.133606 L41.5,162.133606 Z "></path>
                            <animateTransform
                              v-bind:xlink:href="animateId"
      ...
      <TabPane label="路径动画2" name="name3">
        <svg width="500" height="350" viewBox="0 0 500 350">
          ...
          <!-- 三角形 -->
          <path d="M0 0 L-50 -55 L-55 40" id="circle" fill="tomato" />
          <animateMotion xlink:href="#circle" dur="5s" begin="0s" fill="freeze" rotate="auto" repeatCount="indefinite">
      ...
      <TabPane label="路径动画3" name="name4">
        <ul class="svg-list">
          <li>
            <h4>none</h4>
            <svg width="500" height="350" viewBox="0 0 500 350">
          ...
          <li>
            <h4>auto</h4>
            <svg width="500" height="350" viewBox="0 0 500 350">
              <path id="motionPath1" fill="none" stroke="#000000" stroke-miterlimit="10" d="M202.4,58.3c-13.8,0.1-33.3,0.4-44.8,9.2
                  c-14,10.7-26.2,29.2-31.9,45.6c-7.8,22.2-13.5,48-3.5,70.2c12.8,28.2,47.1,43.6,68.8,63.6c19.6,18.1,43.4,26.1,69.5,29.4
                  c21.7,2.7,43.6,3.3,65.4,4.7c19.4,1.3,33.9-7.7,51.2-15.3c24.4-10.7,38.2-44,40.9-68.9c1.8-16.7,3.4-34.9-10.3-46.5
                  c-9.5-8-22.6-8.1-33.2-14.1c-13.7-7.7-27.4-17.2-39.7-26.8c-5.4-4.2-10.4-8.8-15.8-12.9c-4.5-3.5-8.1-8.3-13.2-11
                  c-6.2-3.3-14.3-5.4-20.9-8.2c-5-2.1-9.5-5.2-14.3-7.6c-6.5-3.3-12.1-7.4-19.3-8.9c-6-1.2-12.4-1.3-18.6-1.5
                  C222.5,59,212.5,57.8,202.4,58.3" />
              <g id="car1" transform="translate(-234.4, -182.8)">
                <path d="M234.4,182.8c-3.5,0-6.4,2.9-6.4,6.4c0,3.5,2.9,6.4,6.4,6.4c3.5,0,6.4-2.9,6.4-6.4C240.8,185.6,238,182.8,234.4,182.8z" />
                <circle cx="234.4" cy="189.2" r="2.8" />
                <path d="M263,182.8c-3.5,0-6.4,2.9-6.4,6.4c0,3.5,2.9,6.4,6.4,6.4c3.5,0,6.4-2.9,6.4-6.4C269.4,185.6,266.6,182.8,263,182.8z" />
                <circle cx="263" cy="189.2" r="2.8" />
              ...
              <animateMotion xlink:href="#car1" dur="3s" begin="0s" fill="freeze" repeatCount="indefinite" rotate="auto">
          ...
          <li>
            ...
            <svg width="500" height="350" viewBox="0 0 500 350">
              ...
              <animateMotion xlink:href="#car2" dur="3s" begin="0s" fill="freeze" repeatCount="indefinite" rotate="auto-reverse">
